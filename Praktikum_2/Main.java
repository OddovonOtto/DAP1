public class Main{
    ...
    public static void main(String[] args){
        ...
        int[] intArr = {-120,10,0,8,3,-8,6,7,3,8,1,8,-12,1};
        int[] intArr2 = {1,10,1,9,1,8,1,7,1,6,1,2,3,1};
        Fraction[] testArr = createFractionArr(intArr);
        Fraction[] testArr2 = createFractionArr(intArr2);
        
        //System.out.println("countNegatives: " + countNegatives(testArr));
        //System.out.println("sumUpNegatives: " + sumUpNegatives(testArr));
        //System.out.println("maximum: " + maximum(testArr));
        //System.out.println("countMaximum: " + countMaximum(testArr));
        //System.out.println("isSorted: " + isSorted(testArr2));
        //Fraction[] test = increaseArray(testArr,new Fraction(1,2));
        //System.out.println("doubleIfContainsPositive:");
        //doubleIfContainsPositive(testArr);
        /*
        ...
        //Fraction[] test = selectNegatives(testArr);
        //System.out.println(toString(test));
        
        System.out.println(countSequences(testArr));
    ...
    public static Fraction countSequences(Fraction[]arr){
        ...
        if(arr[arr.length-1].toDouble()!=0){
                count++;
            }
        return new Fraction(count,1);
    }
